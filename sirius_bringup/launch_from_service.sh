...
TERM=xterm-256color tmux new-window -d -t ros: -n web_server "source /home/rover/.nvm/nvm.sh; cd /home/rover/interface/server; npm run start; bash -i"
...
TERM=xterm-256color tmux new-window -d -t ros: -n cameras "cd /home/rover/ip_camera_server; ./mediamtx; bash -i"
